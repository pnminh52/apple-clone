...
function Product(props) {
  ...
  useEffect(() => {
    const colorToApply = props.item.color[props.selectedColorIndex] || props.item.color[0];
    Object.entries(materials).forEach(([name, mat]) => {
      if (
        ...
        mat.color = new THREE.Color(colorToApply);
      }
      mat.needsUpdate = true;
    });
  }, [materials, props.item, props.selectedColorIndex]);
...
useGLTF.preload("/Products/scene.glb");